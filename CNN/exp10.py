...
def run_exp10():
    ...
    for atk in ["BF", "LF", "mimic", "IPM", "ALIE"]:
        for s in [0, 2]:
            ...
            processes.append(subprocess.Popen(["/home/sqk/miniconda3/envs/federated-env/bin/python", "exp10.py"] + args_list))
...
def main_experiment(args):
    ...
    if not args.plot:
        ...
        # g.fig.savefig(OUT_DIR + "exp10.pdf", bbox_inches="tight")
